...
export const getAuthorizationToken = (key: string, secret: string): string => {
  ...
  export const updateBucket = async (
    url, authorizationToken: string, data
  ): Promise<{ [key: string]: any }> => {
  ...
  export const listBuckets = async (
    url,accountId:string, authorizationToken: string,
  ): Promise<{ [key: string]: any }> => {
    ...
    async function GetBucket() {
        try {
          ...
          console.log("bucketData", bucketData)
            ...
            const bucketUpdateResponse  = await updateBucket(authorized.apiUrl, authorized.authorizationToken, bucketUpdateData);
